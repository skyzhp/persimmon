...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_links_vue__ = __webpack_require__(270);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__babel_loader_node_modules_vue_loader_lib_template_compiler_index_id_data_v_aeeccef6_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_links_vue__ = __webpack_require__(332);
...
exports.default = {
    ...
    methods: {
        ...
        handleEdit: function handleEdit(row) {
            ...
            that.myFormTitle = '编辑';
            that.editFormVisible = true;
            _util2.default.ajax.get('/links/' + row.id).then(function (response) {
                var res = response.data;
                if (res != false) {
                    that.myForm = res;
                } else {
        ...
        handleDistory: function handleDistory(type, row) {
            ...
            that.$Modal.confirm({
                ...
                onOk: function onOk() {
                    that.listLoading = true;
                    _util2.default.ajax.delete('/links/destroy', { data: idsParam }).then(function (response) {
                        that.listLoading = false;
                        var res = response.data;
                        that.$Notice.warning({
        ...
        submitMyForm: function submitMyForm(myForm) {
            ...
            that.$refs[myForm].validate(function (valid) {
                ...
                if (that.myForm.id > 0) {
                    _util2.default.ajax.put('/links/update', that.myForm).then(function (response) {
                        var res = response.data;
                        that.$Notice.warning({
...
var update = __webpack_require__(17)("5b55e274", content, false, {});
